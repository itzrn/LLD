/*
There are two approaches to design LLD
Top-down => here we design big object first and then small objects
Bottom-up => here we design small objects first and then big objects
*/

/*
Design an editor which can have text and images.
