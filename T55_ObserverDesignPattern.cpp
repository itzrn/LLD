/*
    Defines a one-to-many relationship between objects so that when one object changes state, all
    of its dependets are notified, and updated automatically


    This patter breaks the SRP
    Channel is doing two things
    1-> subscribe, unsubscribe, notify
    2->upload video, get video


    problems where we can use it
    Notification service
    news feed service
    in the term of event handling
*/
